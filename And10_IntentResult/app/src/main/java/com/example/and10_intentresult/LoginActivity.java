...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //int타입은 참조형 데이터 타입이 아니기 때문에
        //null인상태가 있을수가 없음

  /*      Log.d("메인 액팁티에서 가져온 값 ", test);
        Log.d("메인 액팁티에서 가져온 값 ", num + "");
        Log.d("메인 액팁티에서 가져온 값 ", num1 +"");
        Log.d("메인 액팁티에서 가져온 값 ", dto.getId()+"");
        Log.d("메인 액팁티에서 가져온 값 ", dto.getPw()+"");*/
        Log.d("메인 액팁티에서 가져온 값 ", list.size() + "");

        for(int i = 0; i < 10; i++){
            Log.d("메인 액팁티에서 가져온 값 ", list.get(i)+ "");
        }
