...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.show();//dialog를 만들어 놓고 show를 안하면 절대 안보임.
