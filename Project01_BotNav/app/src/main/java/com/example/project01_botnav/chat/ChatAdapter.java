...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder>{
    ...
    Context context;
    View.OnClickListener showToastLisner;

    public ChatAdapter(LayoutInflater inflater, ArrayList<ChatDTO> list, Context context, View.OnClickListener showToastLisner) {
        this.inflater = inflater;
        this.list = list;
        this.context = context;
        this.showToastLisner = showToastLisner;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(@NonNull ViewHolder h, int i){
            h.imgv.setImageResource(list.get(i).getImg_res());
            h.tv_msg.setText(list.get(i).getMsg());
            h.tv_name.setText(list.get(i).getName());
            h.tv_name.setOnClickListener(showToastLisner);
